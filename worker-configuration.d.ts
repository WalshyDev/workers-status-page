/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f1ccdf032f7d09b2e6302e5e0268377b)
...
declare namespace Cloudflare {
	...
	interface Env {
		CONFIG: {"banner":null,"services":[{"id":"api","name":"API","description":"Core API services and endpoints","link":"https://api.cloudflare.com/"},{"id":"dashboard","name":"Dashbaord","description":"Cloudflare dashboard","link":"https://dash.cloudflare.com/"},{"id":"workers","name":"Workers","description":"Cloudflare workers","link":"https://workers.cloudflare.com/"},{"id":"pages","name":"Pages","description":"Cloudflare pages","link":"https://pages.cloudflare.com/"}]};
		ACCOUNT_ID: string;
		API_TOKEN: string;
